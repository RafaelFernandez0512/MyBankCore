...
namespace CoreWebServices.Models
{
    ...
    public partial class coredbEntities : DbContext
    {
        ...
        public virtual int InsertTransaccion(Nullable<double> montoTransaccion, Nullable<int> iDCuentaEmisor, Nullable<int> iDCuentaReceptor, string tipoTransaccion, string descripción)
        {
            var montoTransaccionParameter = montoTransaccion.HasValue ?
                new ObjectParameter("MontoTransaccion", montoTransaccion) :
                new ObjectParameter("MontoTransaccion", typeof(double));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertTransaccion", montoTransaccionParameter, iDCuentaEmisorParameter, iDCuentaReceptorParameter, tipoTransaccionParameter, descripciónParameter);
        }
        ...
        public virtual int RetiroTransaction(Nullable<double> montoTransaccion, Nullable<int> iDCuentaEmisor, string tipoTransaccion)
        {
            var montoTransaccionParameter = montoTransaccion.HasValue ?
                new ObjectParameter("MontoTransaccion", montoTransaccion) :
                new ObjectParameter("MontoTransaccion", typeof(double));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RetiroTransaction", montoTransaccionParameter, iDCuentaEmisorParameter, tipoTransaccionParameter);
        }
